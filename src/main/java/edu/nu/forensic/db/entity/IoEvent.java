...
//    private String programPoint;
    ...
    public IoEvent(UUID id, String type, Integer threadId, UUID subjectUUID, String predicateObjectPath, long startTimestampNanos, long endTimestampNanos, String names) {
        this.id = id;
        this.type = type;
