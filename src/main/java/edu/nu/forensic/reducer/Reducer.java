...
//                    toBeSavedIoEvent = new IoEvent(event.getId(), event.getTypeNum()+"", event.getThreadId(), event.getSubjectUUID(), event.getPredicateObjectPath(),event.getTimestampNanos(), event.getTimestampNanos(), event.getNames());
